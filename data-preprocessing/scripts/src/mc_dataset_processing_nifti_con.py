...
# ================================================================
def parse_args():
    parser = argparse.ArgumentParser(description="Multi-Center Consecutive 3-channel NIfTI preprocessing")
...
def process_slices(
    ...
    """Process slices using consecutive (i-1, i, i+1) context."""
    ...
    for i in tqdm(slice_indices, desc=f"{id_}-{split}-{subset}"):
        ...
        # 2. Geometry (Padding based on center slice)
...
if __name__ == "__main__":
    ...
    logger.info("Starting Multi-Center Consecutive NIfTI Processing...")
    ...
    logger.info("✅ Multi-Center Consecutive NIfTI Dataset Created.")